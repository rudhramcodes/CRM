...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'attendance',
        element: <ProtectedRoute requiredRoles={['super_admin', 'admin', 'manager', 'employee']}><AttendanceLayout /></ProtectedRoute>,
        children: [
          ...
          { path: 'reports', element: <ProtectedRoute requiredRoles={['super_admin', 'admin', 'manager']}><AttendanceReports /></ProtectedRoute> },
        ],
      },
