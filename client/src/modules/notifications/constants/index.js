import {
  ...
  AlertCircle, CreditCard, FileText, Bell, Trash2, Send, MessageCircle,
} from 'lucide-react';
...
export const NOTIFICATION_CONFIG = {
  ...
  task_deleted:         { icon: Trash2, iconBg: 'bg-red-100 text-red-600', badgeBg: 'bg-red-100 text-red-700', label: 'Task' },
  ...
  project_status_change:{ icon: ArrowRightCircle, iconBg: 'bg-violet-100 text-violet-600', badgeBg: 'bg-violet-100 text-violet-700', label: 'Project' },
  project_chat:         { icon: MessageCircle, iconBg: 'bg-sky-100 text-sky-600', badgeBg: 'bg-sky-100 text-sky-700', label: 'Project' },
...
export const NOTIFICATION_TYPE_GROUPS = [
  ...
  { label: 'Tasks', value: 'task', types: ['task_assigned', 'task_due_soon', 'task_status_change', 'task_comment', 'task_deleted'] },
  ...
  { label: 'Projects', value: 'project', types: ['project_assigned', 'project_status_change', 'project_chat'] },
