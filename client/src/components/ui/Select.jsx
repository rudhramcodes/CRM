...
const SelectTrigger = forwardRef(function SelectTrigger(
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-9.5 w-full items-center justify-between whitespace-nowrap rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-primary-900 shadow-none ring-offset-white',
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ref={ref}
        className={cn(
          'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-lg border border-zinc-200 bg-white text-primary-900 shadow-md',
          position === 'popper' &&
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        'text-zinc-700 focus:bg-zinc-100 focus:text-primary-900',
